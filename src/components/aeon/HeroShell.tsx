      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-page-cream">
        <div className="absolute inset-0 z-10">
          <div
            ...
            style={{
              clipPath: "polygon(0 0, 100% 0, 100% 17%, 50% 44%, 0 17%)",
            }}
          >
            <img
              src="/assets/hero.png"
              alt=""
              className="hero-sky-image absolute inset-0 h-full w-full object-cover object-[50%_80%]"
            />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-10%,transparent,transparent_45%)]" />
          ...
          <div className="absolute inset-x-0 top-0 z-30 flex items-center justify-between px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
            <a
              href="/"
              className="inline-flex w-[138px] items-center transition-opacity duration-300 hover:opacity-80 sm:w-[168px] lg:w-[178px]"
            >
                ...
                {leftNav.map((item, index) => (
                  <li key={item.label} className="flex items-center gap-7">
                    ...
                    {index < leftNav.length - 1 ? (
                      <span className="text-navy-text/35">|</span>
                    ) : null}
                  </li>
                ))}
              </ul>
