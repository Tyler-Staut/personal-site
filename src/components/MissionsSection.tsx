...
function MissionCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-14 break-words font-display text-[2rem] leading-none text-white sm:text-[2.1rem]">
        {title}
      </h3>
      <p className="mt-5 max-w-xs text-[1.05rem] leading-8 text-white/68">
        {description}
      </p>
      <a
        href={href}
